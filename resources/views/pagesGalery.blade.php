...
@section('title','GalleryPage Edit')
...
<div class="main-content">
							...
							<form action="{{url('admin/pages/galery/proses')}}" method="POST">
							{{csrf_field()}}
							{{method_field('POST')}}
                            <div class="container-fluid">
                                <div class="card">
                                    <div class="card-header">
                                           		<h1>
									               <input style="width: 100%; background-color: #f8f9fa;  font-weight: bold;" type="" name="judul" value=" {{$galery->judul}}">
									            </h1>
                                    </div>
                                    <div class="card-body">
                            ...
                            <center><iframe src="{{url('/galery')}}" height="720px" width="100%"></iframe></center>
