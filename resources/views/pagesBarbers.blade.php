...
@section('title','BarbersPage Edit')
...
<div class="main-content">
							...
							<form action="{{url('admin/pages/barbers/proses')}}" method="POST">
							{{csrf_field()}}
							{{method_field('POST')}}
                            <div class="container-fluid">
                                <div class="card">
                                    <div class="card-header">
                                           		<h1>
									               <input style="width: 100%; background-color: #f8f9fa;  font-weight: bold;" type="" name="judul" value=" {{$barbers->judul}}">
									            </h1>
                                    </div>
                                    <div class="card-body">
                            ...
                            <center><iframe src="{{url('/barbers')}}" height="720px" width="100%"></iframe></center>
