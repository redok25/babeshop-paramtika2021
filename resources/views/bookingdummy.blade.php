            ...
            <div class="header-wrap">
                <div class="header-top d-flex justify-content-between align-items-center navbar-expand-lg">
                    ...
                    <div class="col-3 logo">
                        <a href="index.html"><img class="mx-auto" src="{{url('img/logo.png')}}" alt=""></a>
                    </div>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="{{url('booking/proses')}}" method="post">
                            {{csrf_field()}}
                            <div class="mt-10"><input required="" type="text" name="nama" placeholder="Nama" class="single-input"></div>
                            ...
                            <div class="mt-10">
                            Tanggal : <input required="" type="date" name="date" class="single-input">
                            </div>
                            <div class="mt-10">
